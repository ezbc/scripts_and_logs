...
''' Calculates the N(H) / Av correlation for the california molecular cloud. Uses
...
def main():
    ...
    figure_dir = '/d/bip3/ezbc/california/figures/dgr/'
    av_dir = '/d/bip3/ezbc/california/data/av/'
    hi_dir = '/d/bip3/ezbc/california/data/hi/'
    co_dir = '/d/bip3/ezbc/california/data/cfa/'
    ...
    noise_cube, noise_header = pf.getdata(hi_dir + \
            'california_hi_galfa_cube_regrid_planckres_noise.fits', header=True)
    ...
    plot_av_vs_nhi_grid(nhi_images,
                        ...
                        savedir=figure_dir,
                        plot_type='scatter',
                        filename='california_av_vs_nhi_panels.png',
                        color_scale='linear')
    ...
    plot_av_vs_nhi(nhi_image,
            ...
            #limits=[0, 15, 0, 3],
            scale=['linear', 'linear'],
            filename='california_av_vs_nhi_global.png',
            color_scale='log')
