...
def plot_beta_map(header=None, contour_image=None, beta=None, cores=None,
        cores_to_keep=None,
...
def plot_temp_map(header=None, contour_image=None, temp=None, cores=None,
        cores_to_keep=None,
        props=None, cloud_dict=None, regions=None, title=None, limits=None,
        contours=None, boxes=False, savedir='./', filename=None, show=False,
        hi_vlimits=None, vlimits=None, vscale='linear'):
    ...
    if 1:
        ...
        #cb.set_label_text(r'log$_{10}$[$U_{0,M83}$]',)
        cb.set_label_text(r'$T_{\rm dust}$',)
    else:
        from mpl_toolkits.axes_grid1 import make_axes_locatable
        divider = make_axes_locatable(ax)
        #cax = divider.append_axes("right", size="5%", pad=0.05)
...
def main(dgr=None, vel_range=(-5, 15), vel_range_type='single', region=None,
    ...
    for figure_type in figure_types:
        ...
        plot_beta_map(header=beta_header,
                       #beta=np.log10(beta),
                       beta=beta,
        ...
        plot_temp_map(header=beta_header,
                       #beta=np.log10(beta),
                       temp=temp,
                       limits=props['plot_limit']['pixel'],
                       regions=props['regions'],
