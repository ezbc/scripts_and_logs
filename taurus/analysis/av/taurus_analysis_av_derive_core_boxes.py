...
def derive_ideal_box(av_image, cores_dict, box_width, box_height,
    ...
    for core in cores_dict:
        ...
        '''
        mask = myg.get_polygon_mask(av_image, box_vertices)
        av_image[mask==0]=np.NaN
...
def main():
    ...
    box_dict = derive_ideal_box(av_data, cores, 8, 20, core_rel_pos=0.1,
            angle_res=10., av_image_error=av_error_data)
