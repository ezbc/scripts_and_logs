...
def plot_hi_vs_h_grid(cores, limits=None, fit=True, savedir='./',
    ...
    for i, core in enumerate(cores_to_plot):
        ...
        # Adjust asthetics
        ax.set_xlabel(r'$\Sigma_{\rm H\,\textsc{I}}$ + $\Sigma_{\rm H_2}$ ' + \
                       '[M$_\odot$ pc$^{-2}$]',)
...
def main(verbose=True, av_data_type='planck', region=None):
    ...
    # --------------------
    N_monte_carlo_runs = 200 # Number of monte carlo runs
    ...
    cores_to_keep = ['L1495', 'L1495A', 'B213', 'L1498', 'B215',
                     'B18', 'B217', 'B220-1', 'B220-2', 'L1521', 'L1524',
                     'L1527-1',
                     'L1527-2',
                     'L1536',
    ...
    for region_name in ('taurus1', 'taurus2',):
        filename = \
