...
galfaData = pf.getdata(dirPath + 'taurus.galfa.cube.cfaRes.regrid.fits')
...
cfaIntData = pf.getdata(dirPath + 'taurus.cfa.co_Int.fits')
cfaIntHead = pf.getheader(dirPath + 'taurus.cfa.co_Int.fits')
